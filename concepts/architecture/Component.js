 ...
 * 1) stateful: has own state accessible via properties
 * 2) composable: supports parent/child relationships
 * 3) event-driven: might interact with a whole system by firing or listening of events.
 * 4) framework-managed: framework is responsible for create/destroy components and invokes its life-cycle hooks.
 */
